...
// All trackers are env-gated: each block renders only when its id is set, so
// nothing loads (and no console errors) until you paste an id into Vercel.
// Server-side conversion relays (Meta CAPI / TikTok / GA4 MP) live in
// /api/track and use their own server tokens.
